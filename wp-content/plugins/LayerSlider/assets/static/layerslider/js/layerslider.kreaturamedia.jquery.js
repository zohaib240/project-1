        ...
        J.defaults = {
                        ...
                        for (var m in n.plugins)
                            if (r.data("ls-plugin-" + m)) {
                                ...
                                for (var v = 0; v < g.length; v++) {
                                    var S, w = g[v].split(":");
                                    w[0] = ie.trim(w[0]), "" !== w[0] && (S = J.functions.convert.properties(ie.trim(w[1])), -1 === w[0].indexOf("duration") && -1 === w[0].indexOf("delay") || (S /= 1e3), y[w[0]] ? n.plugins[m][y[w[0]]] = S : n.plugins[m][w[0]] = S)
                                }
            ...
            set: {
                ...
                style: function(e) {
                    var t, i, s, a, r, o, n, l, d, c, p, u = e[0],
                        ...
                        y = 0,
                        v = !1,
                        S = parseFloat(u.style.fontSize) || 36,
                    ...
                    t.length && (J.timeouts.loadVimeo = Math.floor(Date.now() / 1e3), J.media.properties.$allMediaLayers = J.media.properties.$allMediaLayers.add(t.closest(".ls-layer")), d = 0, ie("<script>").attr({
                        ...
                        J.media.vimeo.$medias.each(function() {
                            ...
                            var s = i.data(J.defaults.init.dataKey),
                                ...
                                o = "https://vimeo.com/api/oembed.json?url=" + encodeURIComponent("https://vimeo.com/video/" + r + (a.h ? "?h=" + a.h : "")),
                                e = e.split("?")[0].split("//")[1];
                            J.media.vimeo.defaults.player_id = "ls-vimeo-" + d;
                            r = J.media.set.customPoster(i, s);
                            s.mediaProperties = {
                                type: "vimeo",
                                $media: t,
                                embedURL: e,
            ...
            layers: function(e = {}) {
                ...
                if (e.singleLayer || this.$responsiveLayers) {
                    ...
                    for (var t, i = e.singleLayer || this.$responsiveLayers, s = J.slider.initial, a = J.slider.width, r = J.slider.height, o = a / r, n = [], l = [], d = [], c = [], p = 0, u = 0, h = window.LS_previewZoom || 1, m = 0, f = i.length; m < f; m++) {
                        var g = i[m],
                            y = ie(g),
                            v = y.data(J.defaults.init.dataKey),
                            S = !!v.is.insideLayerGroup && y.data("$layerGroup"),
                            w = !!v.is.insideLayerGroup && S.data(J.defaults.init.dataKey),
                            b = e.original ? ie.extend(!0, {}, v.original, e.original) : v.original,
                        ...
                        var T, k = "fixed" == v.settings.position || "fixedx" == v.settings.position,
                            ...
                            P = a,
                            O = r,
                            I = v.is.insideLayerGroup ? (C = k = !1, $ = L = 0, t = P = w.responsive.width, O = w.responsive.height) : (t = T, I);
                        ...
                        var L = k ? 0 : p,
                            $ = C ? 0 : u,
                            B = {
                                width: k && 0 !== b.percentWidth ? P / 100 * b.percentWidth : parseInt(b.width) * x,
                                height: C && 0 !== b.percentHeight ? O / 100 * b.percentHeight : parseInt(b.height) * x,
            ...
            styleProperties: function(e, t, i, s) {
                s.width && -1 !== s.width.indexOf("%") && (s.percentWidth = parseInt(s.width), s.width = parseInt(J.layers.getStyle(s.width, J.slider.initial.percW))), s.height && -1 !== s.height.indexOf("%") && (s.percentHeight = parseInt(s.height), s.height = parseInt(J.layers.getStyle(s.height, J.slider.initial.percH)));
                var a, r = J.resize.layers({
                    singleLayer: e,
                    original: s
                })[0];
                for (a in s) - 1 === a.indexOf("percent") && r.hasOwnProperty(a) && -1 === r[a].indexOf("NaN") && (i[a] = r[a])
            },
            ...
            slide: {
                ...
                normal: {
                    ...
                    setTransition: function(e, t) {
                        ...
                        for (var y, v, S = 0; S < l * d; S++) c.push(S);
                        ...
                        for (var w = 0; w < l * d; w++) {
                            ...
                            if ("3d" == e) {
                                ...
                                switch (this.scale2D = void 0 !== n.transition.scale ? n.transition.scale : 1, 1 == y && 1 != this.scale2D && (R /= 2, N /= 2, E /= 2, Y /= 2), (n.transition.rotate || n.transition.rotateX || n.transition.rotateY || 1 != this.scale2D) && "slide" != n.transition.type ? k.css({
                                    ...
                                    case "fade":
                                        ...
                                        break;
                                    case "mixed":
                                        H = 0, (X = 1) == this.scale2D && (N = Y = 0), B = void 0 !== n.transition.scaleX ? n.transition.scaleX : void 0 !== n.transition.scale ? n.transition.scale : 1, M = void 0 !== n.transition.scaleY ? n.transition.scaleY : void 0 !== n.transition.scale ? n.transition.scale : 1;
                                        break;
                                    case "scale":
                                        switch (H = R = N = E = Y = 0, M = B = X = 1, Z) {
                                            case "left":
                                            case "right":
                                                B = 1 + c[w] / (50 / Q);
                                                break;
                            ...
                            V = w % l * i, q = Math.floor(w / l) * s, void 0 !== J.transitions.curSlide.data.$background && (b = J.transitions.curSlide.data.$background.data(J.defaults.init.dataKey), "3d" === e || "2d" === e && (!0 === v || "slide" === n.transition.type || "scale" === n.transition.type || !0 === y || n.transition.hasOwnProperty("opacity")) ? O.append(ie('<div style="position: absolute;">').css({
                                width: J.slider.width,
                                height: J.slider.height,
                                left: -V,
                                top: -q,
                    ...
                    addLayers: function(e, t, i, s, a, r) {
                        for (var o = 0, n = e.length; o < n; o++) {
                            var l, d, c, p, u, h = e[o],
                                ...
                                S = f.elements.$parallaxWrapper,
                                w = (f.elements.$scrollWrapper, f.elements.$scrollTransformWrapper, f.settings.skipViewport && J.slideshow.state.changed < 1 ? a : i),
                            ...
                            if (f.should.reset && J.transitions.layers.reset(m, f), m.hasClass("ls-bg")) f.kenBurns.zoom && i.fromTo(m.closest(".ls-bg-wrap"), J.transitions.nextSlide.data.duration + J.transitions.nextSlide.data.calculatedTimeShift, {
                                ...
                                case "in":
                                    if (f.in.enabled ? (f.settings.timelineIsCalculated && !f.settings.recalculateTimeline || ("startAtFirst" == f.settings.recalculateTimeline && (f.settings.recalculateTimeline = !1, f.settings.timelineIsCalculated = !1), "number" != typeof f.in.startAt && (f.in.startAt = 0), "number" != typeof f.in.startAtFirst && (f.in.startAtFirst = 0), f.timeline.transitioninstart = J.transitions.firstSlide && f.in.startAtFirst ? f.in.startAtFirst : f.in.startAt, f.timeline.transitioninend = f.timeline.transitioninstart + f.in.duration), J.transitions.firstSlide && f.in.startAtFirst && (f.settings.recalculateTimeline = "startAtFirst"), J.resize.performTransformOperations(f.inLayerToCSS, T), f.in.mirror && "prev" === J.navigation.direction && J.resize.mirrorTransitionProperties({
                                        ...
                                        }, W.onUpdateParams = ["{self}", f.parallax.dummy, S[0], f.parallax.distance, f.parallax.level, f.parallax.type, f.parallax.rotation], M.to(f.parallax.dummy, -1 == f.parallax.path.indexOf("linear") ? f.parallax.duration : f.parallax.duration / 2, W), i.addCallback(function(e) {
                                            e.play()
            ...
            set: {
                ...
                styles: function() {
                    ...
                    if ($.addClass("ls-container ls-" + O), $.parent().addClass("ls-direction-fix"), J.userInitOptions.slideBGSize || "responsive" !== O || !J.userInitOptions.hasOwnProperty("sliderVersion") || J.userInitOptions.sliderVersion || (J.o.slideBGSize = "auto", J.debugMode && J.debug.add("warn", "sliderInit.bgCover", O)), J.o.slideBGSize = J.o.slideBGSize.replace("100% 100%", "stretch"), n = 0 < C ? C : e, l = 0 < P ? P : t, (d = "auto" === (g = L.style.marginLeft) ? "auto" : "" === g ? parseInt(w.getPropertyValue("margin-left")) : parseInt(L.style.marginLeft)) === (c = "auto" === (f = L.style.marginRight) ? "auto" : "" === f ? parseInt(w.getPropertyValue("margin-right")) : parseInt(L.style.marginRight)) && ("" === g && "" === f && (I = d, c = d = "auto"), $.css({
                            marginLeft: "auto",
                            marginRight: "auto"
                        })), p = "" !== S.paddingLeft ? parseInt(S.paddingLeft) : parseInt($.css("padding-left")), h = "" !== S.paddingRight ? parseInt(S.paddingRight) : parseInt($.css("padding-right")), u = "" !== S.paddingTop ? parseInt(S.paddingTop) : parseInt($.css("padding-top")), m = "" !== S.paddingBottom ? parseInt(S.paddingBottom) : parseInt($.css("padding-bottom")), v = "" !== S.borderLeftWidth ? parseInt(S.borderLeftWidth) : parseInt($.css("border-left-width")), g = "" !== S.borderRightWidth ? parseInt(S.borderRightWidth) : parseInt($.css("border-right-width")), f = "" !== S.borderTopWidth ? parseInt(S.borderTopWidth) : parseInt($.css("border-top-width")), S = "" !== S.borderBottomWidth ? parseInt(S.borderBottomWidth) : parseInt($.css("border-bottom-width")), y.initial = {
                            type: O,
                            width: e,
                            height: t,
                            originalWidth: i,
                            ...
                            skinWidth: p + h + v + g,
                            skinHeight: u + m + f + S
                        }, J.debugMode && (J.debug.add("log", "sliderInit.style", [e, t, i, s, C, P, parseInt(n / l * 100) / 100, 0 < a ? a : void 0, [d, c]]), I && J.debug.add("warn", "sliderInit.margin", I)), ie("#ls-global").length || (ie("html").attr("id") ? ie("body").attr("id") || ie("body").attr("id", "ls-global") : ie("html").attr("id", "ls-global")), "static" !== w.getPropertyValue("position") && "absolute" !== w.getPropertyValue("position") && (L.style.position = "relative"), J.o.insertSelector && $[J.o.insertMethod](J.o.insertSelector), J.slider.$hiddenWrapper = ie('<div class="ls-wp-container fitvidsignore ls-hidden" data-layerslider-uid="' + B + '"></div>').addClass($.attr("class")).prependTo("body"), J.slider.$innerWrapper = ie('<div class="ls-inner"></div>'), J.slider.$slideBGColorWrapper = ie('<div class="ls-slide-bgcolor"></div>').appendTo(J.slider.$innerWrapper), J.slider.$layersWrapper = ie('<div class="ls-layers"></div>').appendTo(J.slider.$innerWrapper), J.slider.$bgVideosWrapper = ie('<div class="ls-background-videos"></div>').appendTo(J.slider.$layersWrapper), J.slider.$slideBGWrapper = ie('<div class="ls-slide-backgrounds"></div>').appendTo(J.slider.$layersWrapper), J.slider.$innerWrapper.appendTo($), !0 === J.o.hideOnMobile && te.isMobile ? ($.addClass("ls-forcehide"), $.closest(".ls-wp-fullwidth-container").addClass("ls-forcehide"), J.o.autoStart = !1) : J.slider.check.showHide(), "sticky" === J.o.scene || "scroll" === J.o.scene) {
                        ...
                        $.parent().is("ls-scene-wrapper") ? $.parent().attr("data-scene", J.o.scene).attr("data-layerslider-uid", B) : $.wrap('<ls-scene-wrapper data-scene="' + J.o.scene + '" data-layerslider-uid="' + B + '"></ls-scene-wrapper>'), J.slider.$spacingWrapper = ie('ls-scene-wrapper[data-layerslider-uid="' + B + '"]'), $.attr("data-scene", J.o.scene)
                ...
                options: function() {
                    ...
                    ie("html").find('meta[content*="WordPress"]').length && (J.meta.wpVersion = ie("html").find('meta[content*="WordPress"]').attr("content").split("WordPress")[1]), window.LS_Meta && window.LS_Meta.v ? J.meta.lswpVersion = window.LS_Meta.v : ie("html").find('script[src*="layerslider"]').length && -1 != ie("html").find('script[src*="layerslider"]').attr("src").indexOf("?") && (J.meta.lswpVersion = ie("html").find('script[src*="layerslider"]').attr("src").split("?")[1].split("=")[1]), "undefined" != typeof layerSliderTransitions && (J.t = ie.extend({}, layerSliderTransitions)), "undefined" != typeof layerSliderCustomTransitions && (J.ct = ie.extend({}, layerSliderCustomTransitions)), J.debugMode && ("undefined" != typeof layerCustomSliderTransitions ? (J.debug.add("log", "sliderInit.customTransitions", !1), "undefined" == typeof layerSliderTransitions && J.debug.add("warn", "sliderInit.slideTransitions")) : "undefined" == typeof layerSliderTransitions && J.debug.add("warn", "sliderInit.noSlideTransitions")), "number" == typeof J.o.parallaxCenterDegree && (J.transitions.layers.parallax.defaults.centerDegree = J.o.parallaxCenterDegree), "number" == typeof J.o.parallaxSensitivity && (J.transitions.layers.parallax.defaults.sensitive = J.o.parallaxSensitivity), J.o.parallaxCenterLayers && (J.transitions.layers.parallax.defaults.centerLayers = J.o.parallaxCenterLayers), J.o.scrollCenterLayers && (J.transitions.layers.scroll.defaults.centerLayers = J.o.scrollCenterLayers), J.slider.isSticky && (ie.extend(J.o, {
                        ...
                        pauseOnHover: !1,
                        autoStart: !1
                    }), te.isMobile && (J.o.pauseOnHover = !1), J.o.noContextMenu && $.on("contextmenu." + B, function() {
                        return !1
            ...
            clearEvents: function() {
                M.add("body").add(document).add($).add($.find("*")).add("." + B).off("." + B + " .debug" + B + " .parallax" + B + " .scroll" + B), window._layerSlider.closePopupsOnEsc && window._layerSlider.closePopupsOnEsc[B] && delete window._layerSlider.closePopupsOnEsc[B], delete window._layerSliders[B], $.off()
            }
        }, J.device = {
            scroll: {
            ...
            do: function(t) {
                ...
                switch (t.action) {
                    ...
                    case "scrollToTimelinePosition":
                        ...
                        if (J.slider.isScene || $.removeClass("ls-action-trigger"), "scrollToSelf" === t.action) v = J.slider.$spacingWrapper.offset().top + (t.offset || 0);
                        ...
                        else if ("scrollToPrevProject" === t.action) 0 !== l.index(p) ? (c = l.eq(l.index(p) - 1), v = J.slider.get.scrollTop(c, t)) : s = "There’s no previous project to scroll to.";
                        else if ("scrollToNextProject" === t.action) l.index(p) < l.length - 1 ? (c = l.eq(l.index(p) + 1), v = J.slider.get.scrollTop(c, t)) : s = "There’s no next project to scroll to.";
                            ...
                            c.length ? ((n = c.closest("ls-scene-wrapper")).length && (c = n), v = J.slider.get.scrollTop(c, t)) : s = 'Couldn’t find the scroll target element "' + t.selector + '". Please verify the selector you’ve entered.'
                    ...
                    case "stopSlideshow":
                    case "startSlideshow":
                        "nextSlide" === t.action && (S = "next"), "prevSlide" === t.action && (S = "prev"), "lastSlide" === t.action && (S = "last"), "firstSlide" === t.action && (S = "first"), "stopSlideshow" === t.action && (S = "stop"), "startSlideshow" === t.action && (S = "start"), J.navigation[S]("clicked");
                        break;
                    case "replaySlide":
                        J.api.methods("replay");
                        break;
                    ...
                    case "openPopup":
                        var y, v = ie('[data-ls-slug="' + t.popup + '"], [id^=layerslider_' + t.popup + "]").first(),
                            S = v.data("lsSliderUID");
                        v.length ? ((y = window._layerSliders[S].initializedPlugins.popup).plugin.settings.showOnce = !1, "opened" == y.state.is ? t.toggle && y.events.hide() : t.slide ? v.layerSlider("fastChangeTo", t.slide, function() {
                            y.events.show()
                        }) : y.events.show()) : (v = {
